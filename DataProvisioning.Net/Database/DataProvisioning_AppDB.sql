...
BEGIN
    ...
    VALUES (N'20260324170905_InitialCreate', N'8.0.0');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260326084440_AddInitialAdmins'
)
BEGIN
    CREATE TABLE [initial_admins] (
        [id] int NOT NULL IDENTITY,
        [username] nvarchar(255) NOT NULL,
        CONSTRAINT [PK_initial_admins] PRIMARY KEY ([id])
    );
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260326084440_AddInitialAdmins', N'8.0.0');
END;
GO
